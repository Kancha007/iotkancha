...
channel_secret = "f36e5fcb6dc8b83650a8810f2e699fbc"
channel_access_token = "5/tGzSanFJHppmkQ55nYR0jULHNRdovz2eoGRxwiPu6uN07fIHK20ppGerq8dNeiFKzMvjDPoCZcoy"

broker_address= "mqtt.netpie.io"
port = 1883

client = mqttClient.Client("9326fc07-efb3-48b6-adba-9ed2c98aa4f3") # Client ID
user = "kCrQTPA2yRNWW1hVb2JCt9wrg4hYko3g" # Token
password = "46(kpMTYywjMM$V3BieIa!e4p_9Pf8XU" # Secret
